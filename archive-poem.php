				...
				<div class="post">
					...
					<?php if ( have_posts() ) : ?>
						...
						<div class="poet-search">
							...
							<form role="search" action="<?php echo get_post_type_archive_link( 'poem' ); ?>" method="get" id="searchform">
								<input type="text" name="s" placeholder="<?php esc_attr_e( 'Search Poems', 'commentpress-poets' ); ?>" value="<?php echo ( isset( $_GET['s'] ) ? esc_attr( sanitize_text_field( wp_unslash( $_GET['s'] ) ) ) : '' ); ?>" />
